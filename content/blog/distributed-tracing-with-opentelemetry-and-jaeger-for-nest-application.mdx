...
* **Trace**: A trace is like a complete journey map of a single request as it moves through your entire distributed system. Imagine it as a detailed travel log that follows a request from its starting point to its final destination, capturing every stop and interaction along the way.
    ...
    ![https://www.jaegertracing.io/img/spans-traces.png](/blog/distributed-tracing-with-opentelemetry-and-jaeger-for-nest-application/image-1.png)
...
![Venn diagram showing realtion between Tracing, Metrics and Logging](/blog/distributed-tracing-with-opentelemetry-and-jaeger-for-nest-application/image-2.png)
